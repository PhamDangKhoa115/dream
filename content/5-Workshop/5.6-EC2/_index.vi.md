...
- **Instance type**: `t3.xlarge` _(xem lưu ý bên dưới)_

![Khởi chạy EC2 Instance](/images/5-Workshop/EC2/B1_Launch_EC2.png)
...
![Chọn xlarge](/images/5-Workshop/EC2/B2_Choose_Instance_Type.png)
...
- **Auto-assign public IP**: **Disable** (Tắt) _(instance này nằm trong subnet riêng)_
...
![Cấu hình EC2](/images/5-Workshop/EC2/B3_EC2_Configuration.png)
