...
![Nhấp Create Table](/images/5-Workshop/DynamoDB/B1_Click_Create_Table.png)
...
![Nhập Tên Bảng và Khóa phân vùng](/images/5-Workshop/DynamoDB/B2_Configure_VST.png)
...
![Nhấp Create](/images/5-Workshop/DynamoDB/B3_Create_Table.png)
...
![Cấu hình Bảng memory_AI](/images/5-Workshop/DynamoDB/B4_Configure_MA.png)
...
![Cấu hình Bảng User](/images/5-Workshop/DynamoDB/B5_Configure_User.png)
...
![Xác minh Tất cả các Bảng](/images/5-Workshop/DynamoDB/B6_Final_Check.png)
