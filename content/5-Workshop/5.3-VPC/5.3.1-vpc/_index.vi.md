...
![Tạo VPC](/images/5-Workshop/VPC/B1_Create_VPC.png)
...
![Cấu hình VPC](/images/5-Workshop/VPC/B2_Configure_VPC.png)
...
![Tạo Subnet](/images/5-Workshop/VPC/B3_Create_Subnet.png)
...
![Cấu hình Subnet](/images/5-Workshop/VPC/B4_Configure_Subnet.png)
...
![Menu Internet Gateway](/images/5-Workshop/VPC/B5_Create_IGW.png)
...
![Tạo IGW](/images/5-Workshop/VPC/B6_Create_IGW.png)
...
![Gắn IGW vào VPC](/images/5-Workshop/VPC/B7_Attach_IGW_VPC.png)
...
- **Subnet**: `voice-summarizer-public-subnet` _(NAT Gateway phải nằm trong subnet **public**)_
...
![Tạo NAT Gateway](/images/5-Workshop/VPC/B8_Create_NAT.png)
...
![Tạo Private Route](/images/5-Workshop/VPC/B9_Create_Private_Route.png)
...
![Bảng Private Route đã được tạo](/images/5-Workshop/VPC/B10_Create_Private_RTB.png)
...
![Chỉnh sửa Routes](/images/5-Workshop/VPC/B11_Edit_RTB.png)
...
![Tạo Gateway Endpoints](/images/5-Workshop/VPC/B12_Create_Endpoint_DynamoDB_S3.png)
...
![Tạo Security Group](/images/5-Workshop/VPC/B13_Create_SG.png)
...
![Tuyến đường Bedrock NAT](/images/5-Workshop/VPC/B14_Add_Route_LLM_API.png)
...
![Xác minh Cấu hình Bedrock](/images/5-Workshop/VPC/B15_Verify_Connection.png)
...
![Cài đặt Subnet ALB](/images/5-Workshop/VPC/B16_Assign_PubSubnet_ALB.png)
