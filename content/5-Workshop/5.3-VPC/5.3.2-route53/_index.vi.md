...
![Đi tới Hosted Zones và Tạo](/images/5-Workshop/Route53/B1_Goto_Route53.png)
...
- **Type**: **Public hosted zone** _(phân giải các truy vấn DNS từ internet công cộng)_
- Giữ nguyên tất cả các cài đặt khác ở mức mặc định

Nhấp vào **Create hosted zone**.

![Nhập Tên miền — Public Hosted Zone](/images/5-Workshop/Route53/B2_Enter_Domain.png)
...
![Sao chép các giá trị NS](/images/5-Workshop/Route53/B3_Copy_Value_Route.png)
...
![Thêm các bản ghi NS tại Nhà đăng ký](/images/5-Workshop/Route53/B4_Add_NS_Record_To_Ur_Domain.png)
...
![Tạo Bản ghi bí danh A trỏ đến ALB](/images/5-Workshop/Route53/B5_Create_Alias_Pointing_To_ALB.png)
