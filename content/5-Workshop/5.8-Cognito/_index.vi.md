...
![Mở Cognito User Pools](/images/5-Workshop/Cognito/B1_Navigate_Cognito_Userpool.png)
...
![Chọn SPA](/images/5-Workshop/Cognito/B2_Choose_SPA.png)
...
- **Tự đăng ký (Self-registration)**: ✅ **Enable self-registration** _(cho phép người dùng tự đăng ký)_
...
![Cấu hình Email và Tự Đăng ký](/images/5-Workshop/Cognito/B3_Configure_Auth.png)
...
![Tạo User Pool](/images/5-Workshop/Cognito/B4_Review_Configuration.png)
...
![Sao chép User Pool ID](/images/5-Workshop/Cognito/B5_Copy_Created_UPID.png)
...
![Sao chép Client ID](/images/5-Workshop/Cognito/B6_Copy_ClientID.png)
