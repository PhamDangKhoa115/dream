...
- **Health check path**: `/` _(hoặc `/health` nếu ứng dụng FastAPI của bạn có endpoint kiểm tra sức khỏe)_

![Cài đặt Tạo Target Group](/images/5-Workshop/ALB/B1_Create_TargetGroup.png)
...
![Chọn EC2 Instance](/images/5-Workshop/ALB/B2_Register_EC2_Ins.png)
...
![Xem lại Target Group](/images/5-Workshop/ALB/B2_Review_Info.png)
...
![Tạo Target Group](/images/5-Workshop/ALB/B4_Create_TargetGroup.png)
...
![Chọn Application Load Balancer](/images/5-Workshop/ALB/B5_Choose_ALB.png)
...
- **Scheme**: Internet-facing _(cho phép frontend Amplify tiếp cận từ internet công cộng)_
...
![Cài đặt Cơ bản ALB](/images/5-Workshop/ALB/B6_Configure_ALB.png)
...
![Listener ALB và các Cài đặt Cuối cùng](/images/5-Workshop/ALB/B7_Follow_Configuration.png)
