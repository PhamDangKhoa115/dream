...
![Mở Amplify và Chọn GitHub](/images/5-Workshop/Amplify/B1_Open_Amplify_Choose_Github.png)
...
![Chọn Kho lưu trữ](/images/5-Workshop/Amplify/B2_Select_Repo.png)
...
- **App root directory**: `api/fe` _(frontend React nằm bên trong thư mục con `api/fe/` của monorepo)_
...
![Chọn Nhánh và Thư mục gốc](/images/5-Workshop/Amplify/B3_Choose_Branch_And_Root_Dir.png)
...
![Tạo Ứng dụng Amplify](/images/5-Workshop/Amplify/B4_Review_And_Create.png)
...
![Mở Tên miền Amplify](/images/5-Workshop/Amplify/B5_Wait_For_Deployment.png)
